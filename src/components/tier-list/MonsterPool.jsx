...
/**
 * @typedef {"nat4-fwe"|"nat4-dl"|"nat5-fwe"|"nat5-dl"|"2a"|"all"} TabId
...
export default function MonsterPool() {
	...
	/**
	 * Set des IDs de monstres déjà placés dans l'onglet actif.
	 * @type {Set<number>}
	 */
	const placedIds = useMemo(() => {
		const placedMonsters = placedMonstersByTab[activeTab] ?? {};
		return new Set(Object.values(placedMonsters).flat().map((id) => Number(id)));
	}, [placedMonstersByTab, activeTab]);
